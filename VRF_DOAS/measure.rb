...
#start the measure
class VRFwithDOASMoreDesignParameters < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    # VRF Condenser Type
		...
		# DOAS Heat Type
		doasHeatChs = OpenStudio::StringVector.new
		doasHeatChs << "Gas"
		doasHeatChs << "Electric"
		doasHeatChs << "None"
		doasHeatType = OpenStudio::Ruleset::OSArgument::makeChoiceArgument("doasHeatType",doasHeatChs,true)
		doasHeatType.setDisplayName("DOAS Auxiliary Heat Type")
		doasHeatType.setDefaultValue("Electric")
		args << doasHeatType	
  ...
  def run(model, runner, user_arguments)
    ...
    if not runner.validateUserArguments(arguments(model), user_arguments)
	  ...
	  vrfCondenserType = runner.getStringArgumentValue("vrfCondenserType",user_arguments)
		...
		doasHeatType = runner.getStringArgumentValue("doasHeatType",user_arguments)		
	...
	if doasFanType == "Variable"
		primaryHVAC = {"doas" => true, "fan" => "Variable", "heat" => doasHeatType, "cool" => "SingleDX"} 
	else
		primaryHVAC = {"doas" => true, "fan" => "Constant", "heat" => doasHeatType, "cool" => "SingleDX"}
	end
...
VRFwithDOASMoreDesignParameters.new.registerWithApplication