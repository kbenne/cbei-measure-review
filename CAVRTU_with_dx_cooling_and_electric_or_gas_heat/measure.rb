...
#start the measure
class CAVRTUWithDXCoolingAndElectricOrGasHeat < OpenStudio::Ruleset::ModelUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return " CAV RTU with DX Cooling and Electric or Gas Heat"
  end
  ...
  def arguments(model)
	...
	# make an argument forheating coil type

	heatingcoilChs = OpenStudio::StringVector.new
	heatingcoilChs << "Electric"
	heatingcoilChs << "Gas"
    ...
    heatingcoilType.setDefaultValue("Electric")
  ...
  def run(model, runner, user_arguments)
    ...
    primaryHVAC = {"doas" => false, "fan" => "Constant", "heat" => heatingcoilType, "cool" => "SingleDX", "economizer" => economizer_option, "erv" => erv_option, "coolcoilCOP"=>coolingcoilCOP, "controlZoneSpaceType"=>controlZoneSpaceType}
...
CAVRTUWithDXCoolingAndElectricOrGasHeat.new.registerWithApplication