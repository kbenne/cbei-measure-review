...
#start the measure
class SystemWithElectricHeatingCoil < OpenStudio::Ruleset::ModelUserScript 

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "Add Electric Heating Coil"
  end
  ...
  def arguments(model)
	...
	heatingcoilType.setDefaultValue("ElectricResistance")
...
SystemWithElectricHeatingCoil.new.registerWithApplication